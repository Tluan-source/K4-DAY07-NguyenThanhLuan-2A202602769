...
class EmbeddingStore:
    ...
    def __init__(
        ...
        # The lab contract and tests use the deterministic in-memory backend.
        # Keep the Chroma fields for API compatibility without activating an
        # unimplemented backend when chromadb happens to be installed.
